...
public:
    ThemeSolarizedDark() {
        ...
        // Tooltip Colors
        defaultTooltipBackground = Color(7, 54, 66);      // base02 - dark background
        defaultTooltipText = Color(147, 161, 161);        // base0 - light text
        defaultTooltipBorder = Color(88, 110, 117);       // base01 - medium border
    }
};
