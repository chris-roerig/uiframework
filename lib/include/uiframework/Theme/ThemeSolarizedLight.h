...
public:
    ThemeSolarizedLight() {
        ...
        // Tooltip Colors
        defaultTooltipBackground = Color(238, 232, 213);   // Light cream background
        defaultTooltipText = Color(101, 123, 131);         // Dark blue-gray text
        defaultTooltipBorder = Color(147, 161, 161);       // Medium gray border
    }
};
